<?php
    ...
    function getAll(){
		...
		if (isset($_SESSION["email"]) && isset($_SESSION["user_id"]) ){
			...
			Log::warning("Недостаточно прав для запроса уведомлений");
			$response["msg"] = "Недостаточно прав для запроса уведомлений";
		}
    }
    ...
    function setNotification($uid, $type, $content = null){
		...
		if (isset($_SESSION["email"]) && isset($_SESSION["user_id"]) ){
			...
			Log::warning("Недостаточно прав для добавления уведомления");
			$response["msg"] = "Недостаточно прав для добавления уведомления";
		}
    }
